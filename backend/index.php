<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && $data_request['url'] == 'http://localhost:5173/sign-in-costumer') {
        include './src/controller/user_costumer_controller.php';
        $user_costumer_controller = new UserCostumerController;
        $user_costumer_controller->create($data_request);
    }

    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        include './src/controller/user_costumer_controller.php';
        $user_costumer_controller = new UserCostumerController;
        $user_costumer_controller->list();
    }
?>